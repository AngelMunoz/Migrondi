...
module Cli =
  ...
  type InitArgs =
    ...
    static member GetOptions
      ...
      {
        path =
          defaultArg (results.TryGetResult(Path) |> Option.flatten) defaultPath
  ...
  type UpArgs =
    ...
    static member GetOptions
      ...
      ) : UpOptions =
      {
        ...
        dryRun =
          defaultArg (results.TryGetResult(Dry_Run) |> Option.flatten) true
        noColor = defaultArg noColor false
        json = defaultArg asJson false
      }
  ...
  type ListArgs =
    ...
    static member GetOptions
      ...
      ) : ListOptions =
      {
        ...
        listKind =
          defaultArg
            (results.TryGetResult(Kind) |> Option.flatten)
  ...
  type StatusArgs =
    ...
    static member GetOptions
      (
        results: ParseResults<StatusArgs>,
        ?noColor: bool,
        ?asJson: bool
      ) : StatusOptions =
      {
  ...
  type MigrondiArgs =
    ...
    interface IArgParserTemplate with
      member this.Usage: string =
        match this with
        | Init _ ->
          "Creates basic files and directories to start using migrondi."
